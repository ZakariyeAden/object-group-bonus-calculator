...
function calculateIndividualEmployeeBonus(employee) {
  ...
  if (employee.reviewRating < 2) {
    ...
    // should receive a base bonus of 4% of their base annual income.
    newBonusPercentage = 0.04;
    console.log(
      "should receive a base bonus of 4% of their base annual income."
    );
  } else if (employee.reviewRating === 4) {
    // should receive a base bonus of 6% of their base annual income.
    newBonusPercentage = 0.06;
    console.log(
      "should receive a base bonus of 6% of their base annual income."
    );
  } else if (employee.reviewRating === 5) {
    // receive a base bonus of 10% of their base annual income.
    newBonusPercentage = 0.1;
  ...
  if (employee.employeeNumber.length > 4) {
    ...
    newBonusPercentage = 0.05;
    console.log(
      "for longer than 15 years, and should receive an additional 5%.."
    );
  }
  if (employee.annualSalary > 65000) {
    // they should have their bonus adjusted down 1%.
    // NOTE: this equation isn't working, find new solution
    newBonusPercentage = employee.annualSalary - 0.01;
    console.log("they should have their bonus adjusted down 1%.");
  }
  if (newBonusPercentage > 0.13 || newBonusPercentage < 0) {
